...
public class UpcomingMoviesFragment extends Fragment implements onItemClick {
        ...
        movieList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!loading && (totalItemCount - visibleItemCount) <= (firstVisibleItem + visibleThreshold)) {
                    mainViewModel.noPageUpcoming.postValue(pageNo);
                    loading = true;
                }
            }
        });
    ...
    private void setupViewModel() {
        ...
        mainViewModel.noPageUpcoming.observe(this, integer -> mainViewModel.getMoreData(integer));

        mainViewModel.getUpcomingMovies().observe(this, movies -> {
